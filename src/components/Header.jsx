  ...
  return (
    <div className="py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-6 lg:grid-cols-12 gap-6">
        ...
        >
          ...
          <div className="mb-6">
            ...
            <p className="text-sm text-base-content/70">
              I am a Web Designer based in Pakistan.
            </p>
          </div>
        ...
        <MotionDiv 
          className="bg-base-200 rounded-3xl p-6 flex flex-col md:col-span-2 lg:col-span-4"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          <div className="mt-4 flex justify-end">
            <MotionDiv
              whileHover={{ rotate: 90 }}
              animate={{ rotate: isHoveredProfiles ? 90 : 0 }}
              transition={{ duration: 0.3 }}
              className="bg-base-300 rounded-full w-10 h-10 flex items-center justify-center cursor-pointer"
            >
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* Experience  - 6 cols */}
        {/* <MotionDiv 
          className="bg-base-200 rounded-3xl p-6 flex flex-col md:col-span-6 lg:col-span-12"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <div className="flex-grow flex md:flex-row flex-col items-center justify-between w-full">
            <div className="flex md:flex-row flex-col gap-8 mb-6 md:mb-0">
...
<MotionDiv 
  className="bg-base-200 rounded-3xl p-6 flex flex-col md:col-span-6"
  initial={{ opacity: 0, y: 20 }}
  animate={{ opacity: 1, y: 0 }}
  transition={{ duration: 0.5, delay: 0.5 }}
  onMouseEnter={() => setIsHoveredWork(true)}
