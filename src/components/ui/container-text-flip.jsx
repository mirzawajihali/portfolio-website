...
export function ContainerTextFlip({
  words = ["Web Developer", "Competetive Programmer"],
  interval = 3000,
  className,
  textClassName,
  ...
  return (
    <motion.p
      ...
      className={cn(
        "relative inline-block rounded-lg pt-2 pb-3 text-center text-sm font-bold text-black md:text-sm dark:text-white",
